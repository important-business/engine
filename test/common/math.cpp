...
{
    auto a = common::Vector(5.0f, 5.0f);
    auto b = common::Vector(0.0f, 0.0f);
    auto result = a + b;
...
{
    auto a = common::Vector(40.0f, 50.0f);
    auto b = common::Vector(20.0f, 42.0f);
    auto result = a + b;
...
{
    auto a = common::Vector(-400.0f, -24.0f);
    auto b = common::Vector(-90.0f, -201.0f);
    auto result = a + b;
...
{
    auto a = common::Vector(0.0f, 0.0f);
    auto result = a.mag();
    ASSERT_FLOAT_EQ(0.0f, result);
}
...
{
    auto a = common::Vector(8.0f, 15.0f);
    auto result = a.mag();
...
{
    auto a = common::Vector(-7.0f, -24.0f);
    auto result = a.mag();
